...
<input id="datefield" name="datefield" type="date" min="" max="" required></input></div><br>
<div class="pelement"><label style="font-size:20px;">Select the end date for your reservation:</label>
<input id="datefield2" name="datefield2" type="date" min="" max="" required></input></div><br>
</div>
<div class="pheading">
