...
<table class="ptable">
    ...
    $sql="SELECT car.office_id,price,payment_date,plate_id,customer_id FROM rent natural join car where (rent.payment_date>='$date1' and rent.payment_date<='$date2' and car.office_id='$office_id') ;";
